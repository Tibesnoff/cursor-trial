...
export const ENERGY_UPGRADES: UpgradeConfig[] = [
  ...
  },
  {
    ...
    emoji: '🌌',
    category: 'click_power',
    baseCost: { quantumEnergy: 5000, quantumCrystals: 250 },
    costMultiplier: 2.2,
    maxLevel: 8,
    effect: {
      type: 'multiplier',
  ...
  },
  {
    id: 'cosmic_clicker',
    name: 'Cosmic Clicker',
    description: 'Harnesses cosmic energy for massive click power',
    emoji: '🌠',
    category: 'click_power',
    baseCost: { quantumEnergy: 25000, quantumCrystals: 1000 },
    costMultiplier: 3.0,
    maxLevel: 5,
    effect: {
      type: 'multiplier',
    ...
    prerequisites: ['void_harvester'],
    collectorType: 'energy',
  },
  {
    id: 'dimensional_clicker',
    name: 'Dimensional Clicker',
    description: 'Clicks across multiple dimensions simultaneously',
    emoji: '🌀',
    category: 'click_power',
  ...
  // Special Upgrades
  {
    id: 'auto_clicker',
    name: 'Auto Clicker',
    description: 'Automatically clicks for you (faster with higher levels)',
    emoji: '🤖',
    category: 'special',
    baseCost: { quantumEnergy: 2000, quantumCrystals: 50 },
    costMultiplier: 2.5,
    maxLevel: 10,
    effect: {
      type: 'special',
...
export const CRYSTAL_UPGRADES: UpgradeConfig[] = [
  ...
  },
  {
    ...
    emoji: '🔮',
    category: 'click_power',
    baseCost: { quantumCrystals: 250, quantumEnergy: 1000 },
    costMultiplier: 1.8,
    maxLevel: 15,
    effect: {
      type: 'multiplier',
